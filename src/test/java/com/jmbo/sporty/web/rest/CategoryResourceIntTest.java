...
public class CategoryResourceIntTest {
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.getImagen()).isEqualTo(DEFAULT_IMAGEN);
        assertThat(testCategory.getImagenContentType()).isEqualTo(DEFAULT_IMAGEN_CONTENT_TYPE);
    ...
    public void updateCategory() throws Exception {
        ...
        assertThat(testCategory.getImagen()).isEqualTo(UPDATED_IMAGEN);
        assertThat(testCategory.getImagenContentType()).isEqualTo(UPDATED_IMAGEN_CONTENT_TYPE);
